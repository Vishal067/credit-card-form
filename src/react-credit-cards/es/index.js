  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
        ...
        expiryyear = _this$props2.expiryyear,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: ['rccs__expiry', focused === 'expiry' || focused === 'expiryyear' ? 'rccs--focused' : '', (expiry.substr(0, 1) !== 'M') || (expiryyear.substr(0, 1) !== 'Y') ? 'rccs--filled' : ''].join(' ').trim()
      }, /*#__PURE__*/React.createElement("div", {
        className: "rccs__expiry__valid"
      }, locale.valid), /*#__PURE__*/React.createElement("div", {
        className: "rccs__expiry__value"
      }, expiry, expiryyear.substr(2, 3))), /*#__PURE__*/React.createElement("div", {
    ...
    get: function get() {
      ...
      var expiry_year = this.props.expiryyear;
      var month = '';
      var year = '';
      ...
      //if month is not there replace it with MM
      while (month.length < 2) {
        month += 'M';
      }
      //if year is not there replace it with YY
      while (year.length < 2) {
        year += 'Y';
      }
      ...
      return expiry_year == '' ? "".concat(month, "/").concat(year) : "".concat(month, "/");
    }
  },
...
_defineProperty(ReactCreditCards, "propTypes", {
  ...
  expiryyear: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
